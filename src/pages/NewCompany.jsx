       ...
       if(data.success===true){
        ...
        for(i=0;i<data.errors.length;i++){
          if(data.errors[i].name==="username") 
            ...
            if(data.errors[i].name==="companyName") 
            setCompanyNameError(data.errors[i].value);
            ...
            if(data.errors[i].name==="phone") 
            setPhoneError(data.errors[i].value);
            if(data.errors[i].name==="adress") 
            setAdressError(data.errors[i].value);
